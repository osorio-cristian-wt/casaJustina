...
| 8 | **Sin tracking IoT cadena frío** | Contenedores pasivos | Contenedores IoT estándar | Costo + estandarización |
...
- **BVLOS** — Beyond Visual Line of Sight (drones fuera de vista).
- **CIT** — Cold Ischemia Time. Tiempo de isquemia fría.
- **COFETRA** — Comisión Federal de Trasplantes.
- **CRESI** — Registro de instituciones, equipos y bancos (Argentina).
- **CUCAI / COTAI / CUDAIO / CUCAIBA** — Organismos provinciales de procuración.
- **DBD** — Donation after Brain Death.
- **DCD** — Donation after Circulatory Death (asistolia).
- **DPMH** — Donantes por Millón de Habitantes.
...
- **HSI** — Historia de Salud Integrada (PBA).
...
- **MELD/PELD** — Model for End-stage Liver Disease / Pediatric.
- **ONT** — Organización Nacional de Trasplantes (España).
- **OPO** — Organ Procurement Organization (USA).
- **OPTN** — Organ Procurement and Transplantation Network (USA).
- **SINTRA** — Sistema Nacional de Información de Procuración y Trasplante.
- **SNOMED CT** — Systematized Nomenclature of Medicine – Clinical Terms.
- **UHPROT** — Unidad Hospitalaria de Procuración de Órganos y Tejidos.
- **UNet** — Plataforma central UNOS.
